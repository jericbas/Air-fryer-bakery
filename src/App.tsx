import { Wheat, Settings, Sun, Moon } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-3 mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-center w-16 h-16 bg-primary rounded-full text-primary-content mb-2 shadow-lg mx-auto">
              <Wheat size={36} />
            </div>
